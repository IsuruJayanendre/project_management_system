...
<div class="container mx-auto p-6">
    ...
    <form action="{{ route('projects.update', $project->id) }}" method="POST" class="bg-white p-6 rounded-lg shadow-md">
        ...
        <div class="mb-4">
            ...
            <input type="date" class="w-full px-3 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500" id="remain_date" name="remain_date" value="{{ $project->remain_date }}">
        </div>
