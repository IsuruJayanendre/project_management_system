...
<head>
    ...
    <title>Tailwind Web Template</title>
...
<nav class="fixed top-0 z-50 w-full bg-white border-b border-gray-200 dark:bg-blue-800 dark:border-gray-700">
      ...
      <div class="flex items-center justify-between">
        ...
        <div class="flex items-center">
            <div class="flex items-center ms-3">
              ...
              <div class="z-50 hidden my-4 text-base list-none bg-white divide-y divide-gray-100 rounded-sm shadow-sm dark:bg-blue-700 dark:divide-gray-600" id="dropdown-user">
  ...
  <aside id="logo-sidebar" class="fixed top-0 left-0 z-40 w-64 h-screen pt-20 transition-transform -translate-x-full bg-white border-r border-gray-200 sm:translate-x-0 dark:bg-blue-800 dark:border-gray-700" aria-label="Sidebar">
  ...
  <div class="p-4 sm:ml-64">
     <div class="p-4 border-2 border-white border-solid rounded-lg dark:border-white mt-14">
